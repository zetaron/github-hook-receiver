...
LABEL org.label-schema.schema-version="1.0" \
      ...
      org.label-schema.docker.cmd="docker run -d -p 80 -v ${SECRETS_VOLUME_NAME:-github-hook-receiver-secrets}:/var/cache/secrets --name github-hook-receiver zetaron/github-hook-receiver:1.0.0"
